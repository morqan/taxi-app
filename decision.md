...
`modernize/senior-2026`; `master` оригинала не тронут. **Ветка НЕ запушена и НЕ смержена** —
финал отдаётся на review владельцу.
...
- [ ] **Merge ветки `modernize/senior-2026` — вручную владельцем** (skill не пушит/не мержит).
