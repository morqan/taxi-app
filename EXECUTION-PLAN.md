...
- **Точка возобновления:** следующая — **Ф5** (i18n: i18next + react-i18next + react-native-localize уже установлены; словари az/ru/en из `~/Documents/mobile/taxi-app/App/I18n/languages`).
